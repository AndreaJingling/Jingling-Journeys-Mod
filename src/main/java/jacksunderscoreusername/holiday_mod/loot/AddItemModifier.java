package jacksunderscoreusername.holiday_mod.loot;
...
public class AddItemModifier extends LootModifier {
    ...
    protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        ...
        generatedLoot.add(new ItemStack(this.item, (this.minCount == this.maxCount) ? this.minCount : context.getRandom().nextInt(this.minCount, this.maxCount + 1)));
