...
public class ModItems {
    ...
    public static final RegistryObject<Item> CANDY_CANE = register("candy_cane", CandyCane::new, CandyCane.getProperties(), true);
    public static final RegistryObject<Item> SHARPENED_CANDY_CANE = register("sharpened_candy_cane", SharpenedCandyCane::new, SharpenedCandyCane.getProperties(), true);
    ...
    public static RegistryObject<Item> registerSimpleCandy(String id, java.util.function.Supplier<MobEffectInstance> effectSupplier) {
        return register(id, Item::new, new Item.Properties().food((new FoodProperties.Builder()).nutrition(4).saturationMod(1.2F).effect(effectSupplier, 1.0F).alwaysEat().build()), true);
    }
    ...
    public static RegistryObject<Item> register(String id, Function<Item.Properties, Item> constructor, Item.Properties properties, boolean isCandy) {
