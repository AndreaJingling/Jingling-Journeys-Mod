...
public class SleighConstructionTableScreen extends AbstractContainerScreen<SleighConstructionTableMenu> {
    private static final ResourceLocation GUI = new ResourceLocation(Main.MOD_ID, "textures/gui/sleigh_construction_table_gui.png");

    public SleighConstructionTableScreen(SleighConstructionTableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
